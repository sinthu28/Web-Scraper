...
async function scrollAutomation() {
    ...
    // Your scrolling logic here using mouse wheel
    while (true) {
        // Perform scrolling using mouse wheel
        ...
        // Check if scroll height has not increased, indicating end of scrolling
